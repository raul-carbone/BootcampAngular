...
let condicaoPagamento = "D";

let valorFinalProduto;

if (condicaoPagamento === "A") {

    valorFinalProduto = valorProduto - (valorProduto * 0.1);
    console.log("Forma de Pagamento: " + condicaoPagamento + " - Valor final: R$" + valorFinalProduto)

} else if (condicaoPagamento === "B") {

    valorFinalProduto = valorProduto - (valorProduto * 0.15);
    console.log("Forma de Pagamento: " + condicaoPagamento + " - Valor final: R$" + valorFinalProduto)
